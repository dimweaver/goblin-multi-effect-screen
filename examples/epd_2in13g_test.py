...
try:
    ...
    draw.line([(0,0),(50,50)], fill = epd.BLACK,width = 1)
    draw.line([(0,50),(50,0)], fill = epd.RED,width = 1)
    draw.chord((10, 60, 50, 100), 0, 360, fill = epd.BLACK)
    ...
    draw.text((120, 60), 'OCCASIONALLY FUNCTIONING', font = font15, fill = epd.RED)
    draw.text((110, 90), 'AUDIO UTILITIES', font = font15, fill = epd.RED)
